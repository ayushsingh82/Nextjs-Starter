        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/publish" className="text-white/60 hover:text-white transition-colors">
                  Publish Work
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <form className="space-y-2">
              <input
                ...
                className="w-full px-4 py-2 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-white/40 focus:outline-none focus:border-gray-500"
              />
              <button
                type="submit"
